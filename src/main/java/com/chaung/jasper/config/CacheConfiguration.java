package com.chaung.jasper.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(com.chaung.jasper.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(com.chaung.jasper.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
