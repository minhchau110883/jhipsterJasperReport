...
import { SettlementReportComponent } from 'app/entities/settlement-report/settlement-report.component';
...
describe('Component Tests', () => {
    describe('SettlementReport Management Component', () => {
        let comp: SettlementReportComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(SettlementReportComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.settlementReports[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
