...
import { OrderDeliveryComponent } from 'app/entities/order-delivery/order-delivery.component';
...
describe('Component Tests', () => {
    describe('OrderDelivery Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.orderDeliveries[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
